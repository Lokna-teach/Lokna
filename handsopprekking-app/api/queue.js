import { notifyTeacherNewQueueEntry } from "../lib/push.js";
import { hasActiveDuplicate, publicQueue, readQueue, sendJson, validateStudentEntry, writeQueue } from "../lib/store.js";
...
export default async function handler(request, response) {
  try {
    ...
    if (request.method === "POST") {
      ...
      sendJson(response, 201, { entry: publicQueue([entry])[0], plass: publicQueue(queue).length });
      return;
    }
